...
-- These must be consistent with modules in: 
-- kong.tracing.propagation.extractors and
-- kong.tracing.propagation.injectors
local header_types = {
  "w3c",
  "b3",
  "b3-single",
...
return Schema.define {
  ...
  fields = {
    ...
    {
      default_format = {
        description = "The default header format to use when extractors did not match any format in the incoming headers.",
        type = "string",
        one_of = header_types,
      },
    }
